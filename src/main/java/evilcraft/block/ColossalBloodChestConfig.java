...
public class ColossalBloodChestConfig extends BlockContainerConfig {
    ...
    @ConfigurableProperty(
        category = ConfigurableTypeCategory.MACHINE,
        comment = "The base amount of concurrent items that need to be available before efficiency can rise.",
        isCommandable = true)
    ...
    public void onRegistered() {
        ...
        ResourceLocation texture = new ResourceLocation(
            Reference.MOD_ID,
            Reference.TEXTURE_PATH_MODELS + "colossalBloodChest.png");
        ClientProxy.TILE_ENTITY_RENDERERS
            .put(TileColossalBloodChest.class, new RenderTileEntityColossalBloodChest(model, texture));
    }
