 ...
 *
 */
public class EntangledChalice extends ConfigurableBlockContainer
    implements IInformationProvider, IBlockTank, IBlockRarityProvider {
    ...
    public static void initInstance(ExtendedConfig<BlockConfig> eConfig) {
        if (_instance == null) _instance = new EntangledChalice(eConfig);
    ...
    public int getLightValue(IBlockAccess world, int x, int y, int z) {
        ...
        if (tile != null && tile instanceof TileEntangledChalice) {
            ...
            if (tank.getTank()
                ...
                return (int) Math.min(
                    15,
                    tank.getFillRatio() * tank.getTank()
                        .getFluidType()
                        .getLuminosity());
            }
        }
