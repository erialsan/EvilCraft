...
public class SpiritReanimatorConfig extends BlockContainerConfig {
    ...
    @ConfigurableProperty(
        ...
        comment = "How much mB per tick this machine should consume.")
    ...
    @ConfigurableProperty(
        category = ConfigurableTypeCategory.MACHINE,
        comment = "The required amount of ticks for each reanimation.")
    ...
    @ConfigurableProperty(
        category = ConfigurableTypeCategory.MACHINE,
        comment = "If the Box of Eternal Closure should be cleared after a revival.")
    ...
    public SpiritReanimatorConfig() {
        super(true, "spiritReanimator", null, SpiritReanimator.class);
    }
