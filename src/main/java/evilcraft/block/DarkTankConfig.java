...
public class DarkTankConfig extends BlockContainerConfig {
    ...
    @ConfigurableProperty(
        ...
        comment = "The maximum tank size possible by combining tanks. (Make sure that you do not cross the max int size.)")
    ...
    @ConfigurableProperty(
        category = ConfigurableTypeCategory.MACHINE,
        comment = "The maximum tank size visible in the creative tabs. (Make sure that you do not cross the max int size.)")
    ...
    @ConfigurableProperty(
        category = ConfigurableTypeCategory.MACHINE,
        comment = "If creative versions for all fluids should be added to the creative tab.")
    ...
    public DarkTankConfig() {
        super(true, "darkTank", null, DarkTank.class);
    }
