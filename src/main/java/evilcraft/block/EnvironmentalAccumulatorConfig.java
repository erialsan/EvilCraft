...
public class EnvironmentalAccumulatorConfig extends BlockContainerConfig {
    ...
    @ConfigurableProperty(
        ...
        isCommandable = true,
        comment = "Sets the default amount of ticks the environmental accumulator takes to cool down")
    ...
    @ConfigurableProperty(
        category = ConfigurableTypeCategory.MACHINE,
        isCommandable = true,
        comment = "Sets the default amount of ticks the environmental accumulator takes to process an item.")
    ...
    @ConfigurableProperty(
        category = ConfigurableTypeCategory.MACHINE,
        isCommandable = true,
        comment = "Sets the default default speed in increments per tick with which an item will move when being process by an environmental accumulator.")
    ...
    public void onRegistered() {
        if (MinecraftHelpers.isClientSide()) {
            ...
            ClientProxy.TILE_ENTITY_RENDERERS
                .put(TileEnvironmentalAccumulator.class, new RenderTileEntityEnvironmentalAccumulator());
        }
    }
