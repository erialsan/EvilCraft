...
public class BloodStainedBlock extends ConfigurableBlockWithInnerBlocksExtended {
    ...
    private AlternatingBlockIconComponent alternatingBlockIconComponent = new AlternatingBlockIconComponent(
        getAlternateIconsAmount());
    ...
    public static void initInstance(ExtendedConfig<BlockConfig> eConfig) {
        if (_instance == null) _instance = new BloodStainedBlock(eConfig);
    ...
    public IIcon getIcon(IBlockAccess world, int x, int y, int z, int side) {
        try {
            return this.getIcon(
                ...
                pass,
                alternatingBlockIconComponent.getAlternateIcon(world, x, y, z, side),
                getTile(world, x, y, z).getInnerBlock());
    ...
    public IIcon getIcon(int side, int meta, int renderPass, IIcon defaultIcon, Block baseBlock)
        ...
        if (renderPass < 0) {
            ...
            if (side != ForgeDirection.UP.ordinal()) return RenderHelpers.EMPTYICON;
            return defaultIcon;
        } else {
