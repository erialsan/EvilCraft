...
public class BloodChestConfig extends BlockContainerConfig {
    ...
    @ConfigurableProperty(
        ...
        comment = "If the Blood Chest should add random bad enchants with a small chance to repairing items.",
        isCommandable = true)
    ...
    @ConfigurableProperty(
        category = ConfigurableTypeCategory.MACHINE,
        comment = "The amount Blood mB required for repairing one damage value.",
        isCommandable = true)
    ...
    @ConfigurableProperty(
        category = ConfigurableTypeCategory.MACHINE,
        comment = "The amount of ticks required for repairing one damage value.",
        isCommandable = true)
    ...
    @ConfigurableProperty(
        category = ConfigurableTypeCategory.MACHINE,
        comment = "If the Blood Chest should be able to repair tools from Tinkers' Construct",
        isCommandable = true)
    ...
    private void registerClientSide() {
        ...
        ResourceLocation texture = new ResourceLocation(
            Reference.MOD_ID,
            Reference.TEXTURE_PATH_MODELS + "bloodChest.png");
        ClientProxy.TILE_ENTITY_RENDERERS.put(TileBloodChest.class, new RenderTileEntityBloodChest(model, texture));
        ClientProxy.ITEM_RENDERERS
            .put(Item.getItemFromBlock(BloodChest.getInstance()), new RenderItemBloodChest(model, texture));
    }
