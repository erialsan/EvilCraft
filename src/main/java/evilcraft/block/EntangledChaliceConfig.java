...
public class EntangledChaliceConfig extends BlockContainerConfig {
    ...
    public EntangledChaliceConfig() {
        super(true, "entangledChalice", null, EntangledChalice.class);
    }
    ...
    public void onRegistered() {
        if (MinecraftHelpers.isClientSide()) {
            ResourceLocation textureGem = new ResourceLocation(
                Reference.MOD_ID,
                Reference.TEXTURE_PATH_MODELS + "gem.png");
            ResourceLocation texture = new ResourceLocation(
                Reference.MOD_ID,
                Reference.TEXTURE_PATH_MODELS + "chalice.png");
            ModelGem gem = new ModelGem(textureGem);
            ModelChalice model = new ModelChalice(texture, gem);
            ClientProxy.TILE_ENTITY_RENDERERS
                .put(TileEntangledChalice.class, new RenderTileEntityEntangledChalice(model, texture));
            ClientProxy.ITEM_RENDERERS.put(
