...
public class SanguinaryPedestalConfig extends BlockContainerConfig {
    ...
    @ConfigurableProperty(
        ...
        comment = "Blood multiplier when Efficiency is active.",
        isCommandable = true)
    ...
    public void onRegistered() {
        if (MinecraftHelpers.isClientSide()) {
            ResourceLocation texture = new ResourceLocation(
                Reference.MOD_ID,
                Reference.TEXTURE_PATH_MODELS + "pedestal.png");
            ModelWavefront model = new ModelPedestal(texture);
            ClientProxy.TILE_ENTITY_RENDERERS
                .put(TileSanguinaryPedestal.class, new RenderTileEntitySanguinaryPedestal(model, texture));
            ClientProxy.ITEM_RENDERERS.put(
                Item.getItemFromBlock(SanguinaryPedestal.getInstance()),
