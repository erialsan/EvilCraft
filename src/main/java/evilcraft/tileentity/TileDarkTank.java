        ...
        if (!getTank().isEmpty() && shouldAutoDrain() && !getWorldObj().isRemote) {
            ...
            if (!worldObj.isAirBlock(xCoord + down.offsetX, yCoord + down.offsetY, zCoord + down.offsetZ)) {
                ...
                TileEntity tile = worldObj
                    .getTileEntity(xCoord + down.offsetX, yCoord + down.offsetY, zCoord + down.offsetZ);
                ...
                List<Entity> entities = worldObj.selectEntitiesWithinAABB(
                    Entity.class,
                ...
                for (Entity entity : entities) {
                    if (!getTank().isEmpty() && entity instanceof EntityItem) {
                        ...
                        if (item.getEntityItem() != null && item.getEntityItem()
                            .getItem() instanceof IFluidContainerItem && item.getEntityItem().stackSize == 1) {
