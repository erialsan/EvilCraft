...
public class TileBloodChest extends TickingTankInventoryTileEntity<TileBloodChest> {
     ...
     */
    public static final int SLOTS_CHEST = ContainerBloodChest.CHEST_INVENTORY_ROWS
        * ContainerBloodChest.CHEST_INVENTORY_COLUMNS;
    /**
    ...
    static {
        EMPTY_IN_TANK_TICK_ACTIONS
            .put(IFluidContainerItem.class, new EmptyFluidContainerInTankTickAction<TileBloodChest>());
    ...
    public TileBloodChest() {
        ...
        addTicker(
            new TickComponent<TileBloodChest, ITickAction<TileBloodChest>>(
                this,
                EMPTY_IN_TANK_TICK_ACTIONS,
                SLOT_CONTAINER,
                false));
