...
public class GeneralConfig extends DummyConfig {
    ...
    @ConfigurableProperty(
        ...
        comment = "Server-side: If farting is enabled on this server; Client-side: If farting can be seen at your client.",
        isCommandable = true)
     ...
     */
    @ConfigurableProperty(
        category = ConfigurableTypeCategory.FLUID,
    ...
    @ConfigurableProperty(
        category = ConfigurableTypeCategory.GENERAL,
        comment = "If retro-generation of ores should be enabled. WARNING: This could cause lag if permanently enabled.",
        isCommandable = true)
    ...
    @ConfigurableProperty(
        ...
        comment = "Spawn extra netherfish blocks in all biomes.")
    ...
    @ConfigurableProperty(
        category = ConfigurableTypeCategory.WORLDGENERATION,
        comment = "Minimum block height at which a dark temple can spawn.")
    ...
    @ConfigurableProperty(
        category = ConfigurableTypeCategory.WORLDGENERATION,
        comment = "Maximum block height at which a dark temple can spawn.")
    ...
    @ConfigurableProperty(
        category = ConfigurableTypeCategory.WORLDGENERATION,
        comment = "Frequency at which dark temples should occur. 1 means every chunk, 100 means every 100th chunk.")
    ...
    @ConfigurableProperty(
        category = ConfigurableTypeCategory.WORLDGENERATION,
        comment = "Maximal length of the pillars of a dark temple.")
    ...
    @ConfigurableProperty(
        category = ConfigurableTypeCategory.WORLDGENERATION,
        comment = "Whitelisted dimensions in which dark temples can generate.")
    ...
    @ConfigurableProperty(
        category = ConfigurableTypeCategory.GENERAL,
        comment = "The amount of mB that can flow per tick out of machines and items.",
        requiresMcRestart = true)
    ...
    @ConfigurableProperty(
        category = ConfigurableTypeCategory.GENERAL,
        comment = "[Thaumcraft] If temporary warp should be added when hit by a Vengeance Spirit.",
        requiresMcRestart = true)
