...
public class ForestryRecipeManager {
    ...
    public static void register() {
        ...
        if (Configs.isEnabled(UndeadLogConfig.class) && Configs.isEnabled(BloodConfig.class)
        ...
        if (Configs.isEnabled(UndeadLeavesConfig.class) && Configs.isEnabled(BloodConfig.class)
            && Configs.isEnabled(HardenedBloodShardConfig.class)) {
            int time = 10;
