...
public class BoundBloodDrop extends ConfigurableDamageIndicatedItemFluidContainer {
    ...
    public static void initInstance(ExtendedConfig<ItemConfig> eConfig) {
        if (_instance == null) _instance = new BoundBloodDrop(eConfig);
    ...
    private static int getCurrentEssence(String owner) {
        return ClientSoulNetworkHandler.getInstance()
            .getCurrentEssence(owner);
    }
    ...
    public void addInformation(ItemStack itemStack, EntityPlayer entityPlayer, List list, boolean par4) {
        ...
        if (itemStack.getTagCompound() != null) {
            ...
            if (owner == null || owner.isEmpty()) {
                owner = EnumChatFormatting.ITALIC
                    + L10NHelpers.localize(getUnlocalizedName() + ".info.currentOwner.none");
            }
    ...
    public FluidStack getFluid(ItemStack container) {
        ...
        return BloodFluidConverter.getInstance()
            .convert(drainedEssence);
    }
    ...
    public int fill(ItemStack container, FluidStack resource, boolean doFill) {
        ...
        FluidStack essenceFluid = BloodFluidConverter.getInstance()
            .convertReverse(AlchemicalWizardry.lifeEssenceFluid, resource);
    ...
    public FluidStack drain(ItemStack container, int maxDrain, boolean doDrain) {
        ...
        FluidStack toDrainEssence = BloodFluidConverter.getInstance()
            .convertReverse(AlchemicalWizardry.lifeEssenceFluid, toDrain);
