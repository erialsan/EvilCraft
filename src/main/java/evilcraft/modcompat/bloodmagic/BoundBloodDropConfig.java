...
public class BoundBloodDropConfig extends ItemConfig {
    ...
    @ConfigurableProperty(
        ...
        comment = "The maximum capacity in (Blood) mB that can be filled.",
        isCommandable = true)
    ...
    @ConfigurableProperty(
        ...
        comment = "The amount of ticks the server should wait before sending a soul network update. (only for servers)")
