...
public class ThermalExpansionModCompat implements IModCompat {
    ...
    private void registerThermalExpansionRecipes() {
        ...
        if (Configs.isEnabled(UndeadLogConfig.class) && Configs.isEnabled(UndeadPlankConfig.class)) {
            ...
            new ItemStack(UndeadLogConfig._instance.getBlockInstance())
                .writeToNBT(sawmillUndeadWood.getCompoundTag("input"));
            new ItemStack(UndeadPlankConfig._instance.getBlockInstance(), 6)
                .writeToNBT(sawmillUndeadWood.getCompoundTag("primaryOutput"));
        ...
        if (Configs.isEnabled(DarkOreConfig.class) && Configs.isEnabled(DarkGemConfig.class)) {
            ...
            if (crushedEnabled) {
                new ItemStack(DarkGemCrushedConfig._instance.getItemInstance(), 1)
                    .writeToNBT(pulverizerDarkOre.getCompoundTag("secondaryOutput"));
            }
        ...
        if (Configs.isEnabled(DarkGemConfig.class) && Configs.isEnabled(DarkGemCrushedConfig.class)) {
            ...
            new ItemStack(DarkGemCrushedConfig._instance.getItemInstance(), 1)
                .writeToNBT(pulverizerDarkOre.getCompoundTag("primaryOutput"));
            FMLInterModComms.sendMessage(TE, "PulverizerRecipe", pulverizerDarkOre);
        }
        ...
        if (Configs.isEnabled(EnderTearConfig.class)) {
            ...
            if (ender != null) {
                ...
                new ItemStack(EnderTearConfig._instance.getItemInstance())
                    .writeToNBT(crucibleEnder.getCompoundTag("input"));
        ...
        if (Configs.isEnabled(HardenedBloodShardConfig.class)) {
            ...
            new ItemStack(HardenedBloodShardConfig._instance.getItemInstance())
                .writeToNBT(crucibleBloodShard.getCompoundTag("input"));
        ...
        if (Configs.isEnabled(BloodInfuserConfig.class)) {
            for (IRecipe<ItemFluidStackAndTierRecipeComponent, ItemStackRecipeComponent, DurationXpRecipeProperties> recipe : BloodInfuser
                ...
                if (recipe.getInput()
                    ...
                    recipe.getInput()
                        .getItemStack()
                        .writeToNBT(bloodInfuse.getCompoundTag("input"));
                    recipe.getOutput()
                        .getItemStack()
                        .writeToNBT(bloodInfuse.getCompoundTag("output"));
        ...
        for (Entry<Item, FluidStack> entry : Recipes.BUCKETS.entrySet()) {
            ...
            entry.getValue()
                .copy()
                .writeToNBT(fill.getCompoundTag("fluid"));
        ...
        if (Configs.isEnabled(BloodWaxedCoalConfig.class)) {
            ...
            new ItemStack(BloodWaxedCoalConfig._instance.getItemInstance())
                .writeToNBT(pulverizerDustCoal.getCompoundTag("input"));
            List<ItemStack> dustCoalList = OreDictionary.getOres("dustCoal");
            if (!dustCoalList.isEmpty()) {
                ItemStack dustCoal = dustCoalList.get(0)
                    .copy();
                ...
                if (!sulfurList.isEmpty()) {
                    ...
                    ItemStack dustSulfur = sulfurList.get(0)
                        .copy();
