    ...
    private class CachedEnvironmentalAccumulatorRecipe extends CachedRecipe {
        ...
        public CachedEnvironmentalAccumulatorRecipe(EnvironmentalAccumulatorRecipeComponent input,
            ...
            this(
                ...
                output.getItemStack(),
                output.getWeatherType(),
                properties.getDuration());
        }

        public CachedEnvironmentalAccumulatorRecipe(ItemStack inputStack, WeatherType inputWeather,
            ItemStack outputStack, WeatherType outputWeather, int duration) {
            this.inputStack = new PositionedStack(inputStack, 36, 48);
        ...
        public int hashCode() {
            ...
            result = prime * result + ((outputWeather == null) ? 0 : outputWeather.hashCode());
            return result;
        }
        ...
        public boolean equals(Object obj) {
            ...
            if (outputWeather == null) {
                if (other.outputWeather != null) return false;
            } else if (!outputWeather.equals(other.outputWeather)) return false;
            return true;
        }
    ...
    public void loadTransferRects() {
        transferRects.add(
            new RecipeTransferRect(
                new Rectangle(progressTargetX, progressTargetY, progressWidth, progressHeight),
