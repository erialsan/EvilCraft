...
public class Waila {
    ...
    public static void callbackRegister(IWailaRegistrar registrar) {
        ...
        registrar.addConfig(
            Reference.MOD_NAME,
            getInnerBlockConfigID(),
            L10NHelpers.localize("gui.waila.innerBlocksConfig"));
        registrar.addConfig(
            Reference.MOD_NAME,
            getBoxOfEternalClosureConfigID(),
            L10NHelpers.localize("gui.waila.boxOfEternalClosureConfig"));
        registrar
            .addConfig(Reference.MOD_NAME, getBlockInfoConfigID(), L10NHelpers.localize("gui.waila.blockInfoConfig"));
