 ...
 *
 */
public class ContainerSanguinaryEnvironmentalAccumulator
    extends ContainerTileWorking<TileSanguinaryEnvironmentalAccumulator> {
     ...
     */
    public ContainerSanguinaryEnvironmentalAccumulator(InventoryPlayer inventory,
        TileSanguinaryEnvironmentalAccumulator tile) {
        super(inventory, tile);

        // Adding inventory
        addSlotToContainer(
            new SlotWorking<TileSanguinaryEnvironmentalAccumulator>(
                TileSanguinaryEnvironmentalAccumulator.SLOT_ACCUMULATE,
                SLOT_ACCUMULATE_X,
                SLOT_ACCUMULATE_Y,
                tile)); // Accumulate slot
        addSlotToContainer(
            new SlotRemoveOnly(
                tile,
                TileSanguinaryEnvironmentalAccumulator.SLOT_ACCUMULATE_RESULT,
                SLOT_ACCUMULATE_RESULT_X,
                SLOT_ACCUMULATE_RESULT_Y)); // Accumulate result slot
