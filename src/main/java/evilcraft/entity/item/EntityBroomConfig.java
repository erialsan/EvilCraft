...
public class EntityBroomConfig extends EntityConfig {
    ...
    @ConfigurableProperty(
        category = ConfigurableTypeCategory.ENTITY,
        isCommandable = true,
        comment = "Defines the maximum number of blocks the client's broom position can be out of sync with the position sent by the server.")
    ...
    @ConfigurableProperty(
        category = ConfigurableTypeCategory.ENTITY,
        isCommandable = true,
        comment = "Defines the maximum number of blocks the client's broom should move when we notice there is a desync between the client's and server's position.")
    ...
    public EntityBroomConfig() {
        super(true, "broomEntity", null, EntityBroom.class);
    }
