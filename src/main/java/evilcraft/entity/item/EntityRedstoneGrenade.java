    ...
    protected void onImpact(MovingObjectPosition pos) {
        ...
        if (worldObj.isAirBlock(pos.blockX + dx, pos.blockY + dy, pos.blockZ + dz)) {
            if (Configs.isEnabled(InvisibleRedstoneBlockConfig.class)) {
                worldObj
                    .setBlock(pos.blockX + dx, pos.blockY + dy, pos.blockZ + dz, InvisibleRedstoneBlock.getInstance());
            }
            ...
            if (worldObj.isRemote) {
                ...
                worldObj.spawnParticle("reddust", pos.blockX + x, pos.blockY + y, pos.blockZ + z, 1, 0, 0);
            }
        }
