...
public class VengeanceSpiritConfig extends MobConfig {
    ...
    @ConfigurableProperty(
        ...
        comment = "Should the Vengeance Spirit be enabled?",
    ...
    @ConfigurableProperty(
        category = ConfigurableTypeCategory.MOB,
        comment = "The maximum amount of vengeance spirits naturally spawnable in the spawnLimitArea.")
    ...
    @ConfigurableProperty(
        category = ConfigurableTypeCategory.MOB,
        comment = "The area in which the spawn limit will be checked on each spawn attempt.")
    ...
    public static String[] entityBlacklist = new String[] { "werewolf", };
    ...
    @ConfigurableProperty(
        category = ConfigurableTypeCategory.MOB,
        comment = "The 1/X chance that an actual spirit will spawn when doing actions like mining with the Vengeance Pickaxe.")
                ...
                public boolean handle(FMLInterModComms.IMCMessage message) {
                    ...
                    try {
                        Class<EntityLivingBase> clazz = (Class<EntityLivingBase>) Class
                            .forName(message.getStringValue());
                        ...
                        EvilCraft.log(
                            "IMC blacklist vengeance spirit did not provide a class of type EntityLivingBase.",
                            Level.ERROR);
                        return false;
                    }
                    return true;
