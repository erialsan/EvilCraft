...
public class FartKeyHandler implements KeyHandler {
    ...
    public void onKeyPressed(KeyBinding kb) {
        ...
        if (kb == Keys.FART.keyBinding) {
            ...
            if (fartingEnabled) player
                .addChatComponentMessage(new ChatComponentText(L10NHelpers.localize("chat.command.fartingEnabled")));
            else player
                .addChatComponentMessage(new ChatComponentText(L10NHelpers.localize("chat.command.fartingDisabled")));
        }
