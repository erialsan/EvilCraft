...
public class ExtendedEntityExplodeFX extends EntityExplodeFX {
     ...
     */
    public ExtendedEntityExplodeFX(World world, double x, double y, double z, double motionX, double motionY,
        double motionZ, float red, float green, float blue, float alpha) {
