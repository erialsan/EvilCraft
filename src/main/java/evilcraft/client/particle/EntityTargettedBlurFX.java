...
public class EntityTargettedBlurFX extends EntityBlurFX {
     ...
     */
    public EntityTargettedBlurFX(World world, float scale, double motionX, double motionY, double motionZ, float red,
        float green, float blue, float ageMultiplier, double targetX, double targetY, double targetZ) {
