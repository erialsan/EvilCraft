...
public class RenderEntityItemDarkStick implements IItemRenderer {
    ...
    private void renderDroppedItem(EntityItem entity, IIcon icon, int p_77020_3_, float p_77020_4_, float p_77020_5_,
        ...
        b0 = RenderItem.getInstance()
            .getMiniItemCount(itemstack, b0);
        ...
        for (int k = 0; k < b0; ++k) {
            ...
            ItemRenderer.renderItemIn2D(
                ...
                f14,
                f5,
                ((IIcon) icon).getIconWidth(),
                ((IIcon) icon).getIconHeight(),
                f9);
