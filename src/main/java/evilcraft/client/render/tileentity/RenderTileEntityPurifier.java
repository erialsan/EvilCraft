...
public class RenderTileEntityPurifier extends TileEntitySpecialRenderer {
    ...
    private static final ResourceLocation TEXTURE_BLOOK = new ResourceLocation(
        Reference.MOD_ID,
        Reference.TEXTURE_PATH_ENTITIES + "blook.png");
    private static final ResourceLocation TEXTURE_ENCHANTEDBOOK = new ResourceLocation(
        Reference.MOD_ID,
        Reference.TEXTURE_PATH_ENTITIES + "enchantedBook.png");
    ...
    public void renderTileEntityAt(TileEntity tileEntity, double x, double y, double z, float partialTickTime) {
        ...
        if (tile != null) {
            ...
            if (additionalItem != null) {
                if (additionalItem.getItem() == DisenchantPurifyAction.ALLOWED_BOOK
                    || additionalItem.getItem() == Items.enchanted_book) {
    ...
    private void renderAdditionalItem(TilePurifier tile, World world, ItemStack itemStack, double x, double y, double z,
        ...
        for (speedUp = tile.additionalRotation2 - tile.additionalRotationPrev; speedUp
            >= (float) Math.PI; speedUp -= ((float) Math.PI * 2F)) {}
    ...
    private void renderBook(TilePurifier tile, World world, ItemStack itemStack, double x, double y, double z,
        float partialTickTime) {
        GL11.glPushMatrix();
        GL11.glTranslatef((float) x + 0.5F, (float) y + 0.75F, (float) z + 0.5F);
        float tick = (float) tile.tickCount + partialTickTime;
        ...
        if (itemStack.getItem() == DisenchantPurifyAction.ALLOWED_BOOK) this.bindTexture(TEXTURE_BLOOK);
        else this.bindTexture(TEXTURE_ENCHANTEDBOOK);
