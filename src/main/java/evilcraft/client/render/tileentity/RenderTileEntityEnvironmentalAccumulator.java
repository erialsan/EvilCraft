...
public class RenderTileEntityEnvironmentalAccumulator extends RenderTileEntityBeacon {
    ...
    @Override
    public void renderBeacon(EvilCraftBeaconTileEntity tileentity, double x, double y, double z,
        ...
        if (tile.getHealth() != tile.getMaxHealth()) BossStatus.setBossStatus(tile, false);
