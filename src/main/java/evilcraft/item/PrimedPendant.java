...
public class PrimedPendant extends ConfigurableDamageIndicatedItemFluidContainer
    implements IBauble, IGuiContainerProvider {
    ...
    public static void initInstance(ExtendedConfig<ItemConfig> eConfig) {
        if (_instance == null) _instance = new PrimedPendant(eConfig);
    ...
    private PrimedPendant(ExtendedConfig<ItemConfig> eConfig) {
        ...
        if (MinecraftHelpers.isClientSide()) setGUI(GuiPrimedPendant.class);
            ...
            for (PotionEffect potionEffect : potionEffects) {
                ...
                list.add(
                    L10NHelpers.localize(
                        super.getUnlocalizedName(itemStack) + ".potion",
