...
public class WeatherContainer extends ConfigurableItem {
    ...
    public static void initInstance(ExtendedConfig<ItemConfig> eConfig) {
        if (_instance == null) _instance = new WeatherContainer(eConfig);
    ...
    public static WeatherContainerTypes getWeatherContainerType(int damage) {
        if (damage > WeatherContainerTypes.values().length) return WeatherContainerTypes.EMPTY;
    ...
    public enum WeatherContainerTypes {
        ...
        private WeatherContainerTypes(WeatherType type, String description, EnumChatFormatting damageColor,
            int damageRenderColor) {
            this.type = type;
        ...
        public void onFill(World world, ItemStack containerStack) {
            ...
            for (WeatherContainerTypes type : values()) {
                if (type.type != null && type.type.isActive(world)) currentWeatherType = type;
            }
        ...
        public void onUse(World world, ItemStack containerStack) {
            ...
            if (type != null) type.activate(world);
        ...
        public static WeatherContainerTypes getWeatherContainerType(WeatherType weatherType) {
            for (WeatherContainerTypes type : values()) {
                if (type.type == weatherType) return type;
            }
