...
public class VengeancePickaxeConfig extends ItemConfig {
    ...
    @ConfigurableProperty(
        ...
        comment = "The area of effect in blocks in which this tool could enable vengeance spirits.",
        isCommandable = true)
    ...
    @ConfigurableProperty(
        category = ConfigurableTypeCategory.ITEM,
        comment = "The ^-1 chance for which vengeance spirits could be toggled.",
        isCommandable = true)
