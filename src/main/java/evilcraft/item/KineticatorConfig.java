...
public class KineticatorConfig extends ItemConfig {
    ...
    @ConfigurableProperty(
        ...
        comment = "If the Kineticator should also attract XP orbs.",
        isCommandable = true)
    ...
    @ConfigurableProperty(
        category = ConfigurableTypeCategory.ITEM,
        comment = "The amount of ticks inbetween each area checking for items.",
        isCommandable = true)
    ...
    @ConfigurableProperty(
        category = ConfigurableTypeCategory.ITEM,
        comment = "The amount of ticks in between each blood consumption when there are valid items in the area.",
        isCommandable = true)
    ...
    public static String[] kineticateBlacklist = new String[] { "appliedenergistics2:item.ItemCrystalSeed", };
