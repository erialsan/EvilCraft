...
public class BloodExtractorConfig extends ItemConfig {
    ...
    @ConfigurableProperty(
        ...
        comment = "The minimum multiplier for amount of mB to receive per mob HP.",
        isCommandable = true)
    ...
    @ConfigurableProperty(
        category = ConfigurableTypeCategory.ITEM,
        comment = "The maximum multiplier for amount of mB to receive per mob HP. IMPORTANT: must be larger than maximumMobMultiplier!",
        isCommandable = true)
    ...
    @ConfigurableProperty(
        category = ConfigurableTypeCategory.ITEM,
        comment = "The amount of blood (mB) this container can hold.",
