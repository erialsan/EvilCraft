...
public class HardenedBloodShardConfig extends ItemConfig {
    ...
    @ConfigurableProperty(
        ...
        comment = "The minimum amount of shards from when using flint 'n steel on Hardened Blood.",
        isCommandable = true)
    ...
    @ConfigurableProperty(
        category = ConfigurableTypeCategory.ITEM,
        comment = "The additional random amount of shards from when using flint 'n steel on Hardened Blood.",
        isCommandable = true)
