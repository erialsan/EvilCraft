...
public class ItemPowerableHelpers {
     ...
     */
    public static boolean onPowerableItemItemRightClick(ItemStack itemStack, World world, EntityPlayer player,
        int powerLevels, boolean onSneak) {
            ...
            if (!world.isRemote) {
                ...
                player.addChatMessage(
                    new ChatComponentText(
                        EnumChatFormatting.ITALIC + L10NHelpers.localize("item.powerable.setPower", newPower)));
            }
            return true;
        }
        return false;
