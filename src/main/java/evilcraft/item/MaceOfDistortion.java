...
public class MaceOfDistortion extends Mace {
    ...
    public static void initInstance(ExtendedConfig<ItemConfig> eConfig) {
        if (_instance == null) _instance = new MaceOfDistortion(eConfig);
     ...
     */
    public void distortEntity(World world, EntityPlayer player, Entity entity, double x, double y, double z,
        int itemUsedCount, int power) {
    ...
    protected static void showEntityDistored(World world, EntityPlayer player, Entity entity, int power) {
        ...
        world.playSoundAtEntity(
            entity,
            "random.explode",
            (float) (power + 1) / (float) POWER_LEVELS,
        ...
        world.spawnParticle(
            "largeexplode",
            entity.posX,
            entity.posY + itemRand.nextFloat(),
            entity.posZ,
            1.0D,
            0.0D,
            0.0D);
