...
public interface ISuperRecipeRegistry extends IRegistry {
     ...
     */
    public <M extends IMachine<M, I, O, P>, I extends IRecipeInput, O extends IRecipeOutput, P extends IRecipeProperties> IRecipeRegistry<M, I, O, P> getRecipeRegistry(
        M machine);
