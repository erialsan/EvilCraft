...
public final class PacketHandler {
    ...
    public static void init() {
        ...
        if (FMLCommonHandler.instance()
            ...
            channel.pipeline()
                .addAfter(codecName, "ClientHandler", new HandlerClient());
        }
    }
    ...
    public static void sendToServer(PacketBase packet) {
        getClientChannel().attr(FMLOutboundHandler.FML_MESSAGETARGET)
    ...
    public static void sendToPlayer(PacketBase packet, EntityPlayer player) {
        getServerChannel().attr(FMLOutboundHandler.FML_MESSAGETARGET)
            .set(FMLOutboundHandler.OutboundTarget.PLAYER);
        getServerChannel().attr(FMLOutboundHandler.FML_MESSAGETARGETARGS)
            .set(player);
