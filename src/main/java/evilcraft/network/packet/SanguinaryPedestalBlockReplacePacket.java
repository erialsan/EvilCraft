...
public class SanguinaryPedestalBlockReplacePacket extends PacketCodec {
    ...
    public void actionClient(World world, EntityPlayer player) {
        ...
        EvilCraft.proxy.playSoundMinecraft(
            x,
            y,
            z,
            block.stepSound.getBreakSound(),
            0.1F + world.rand.nextFloat() * 0.5F,
            0.9F + world.rand.nextFloat() * 0.1F);
        EntityBloodSplashFX
            .spawnParticles(world, (int) x, (int) y + 1, (int) z, 3 + world.rand.nextInt(2), 1 + world.rand.nextInt(2));
    }

    @Override
    public void actionServer(World world, EntityPlayerMP player) {
        PacketHandler.sendToAllAround(
            new SanguinaryPedestalBlockReplacePacket(x, y, z, blockID),
