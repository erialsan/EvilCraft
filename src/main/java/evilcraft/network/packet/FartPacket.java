...
public class FartPacket extends PacketCodec {
    ...
    public void actionClient(World world, EntityPlayer player) {
        if (GeneralConfig.farting) {
            boolean isRemotePlayer = !player.getDisplayName()
                .equals(displayName);
    ...
    @SideOnly(Side.CLIENT)
    private void spawnFartParticles(World world, EntityPlayer player, double posX, double posY, double posZ,
    ...
    public boolean hasRainbowFart(EntityPlayer player) {
        return player.getGameProfile() != null && ALLOW_RAINBOW_FARTS.contains(
