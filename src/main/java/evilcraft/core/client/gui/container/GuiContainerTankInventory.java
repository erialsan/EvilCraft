...
public class GuiContainerTankInventory<T extends TankInventoryTileEntity> extends GuiContainerExtended {
    ...
    protected void setProgress(int progressWidth, int progressHeight, int progressX, int progressY, int progressTargetX,
        int progressTargetY) {
    ...
    protected void drawGuiContainerBackgroundLayer(float f, int x, int y) {
        ...
        if (isShowProgress()) {
            this.drawTexturedModalRect(
                guiLeft + progressTargetX,
                guiTop + progressTargetY,
                progressX,
                progressY,
                getProgressXScaled(progressWidth),
                getProgressYScaled(progressHeight));
        }
    }
    ...
    protected void drawTooltips(int mouseX, int mouseY) {
        if (isPointInRegion(tankTargetX, tankTargetY - tankHeight, tankWidth, tankHeight, mouseX, mouseY)
            && shouldRenderTank()) {
            SingleUseTank tank = tile.getTank();
