 ...
 * @author immortaleeb
 */
public class EnvironmentalAccumulatorRecipeComponent
    implements IRecipeInput, IRecipeOutput, IItemStackRecipeComponent, IWeatherTypeRecipeComponent {
    ...
    public ItemStack getConditionalItemStack(ItemStack inputStack) {
        ...
        if (inputStack != null && inputStack.hasTagCompound()) {
            ...
            for (String key : (Set<String>) inputStack.getTagCompound()
                .func_150296_c()) {
