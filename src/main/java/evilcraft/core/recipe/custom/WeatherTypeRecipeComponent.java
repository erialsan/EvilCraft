 ...
 */
@Data
public class WeatherTypeRecipeComponent
    implements IRecipeInput, IRecipeOutput, IRecipeProperties, IWeatherTypeRecipeComponent {
    ...
    public boolean equals(Object object) {
        ...
        return this.weatherType.equals(that.weatherType) || this.weatherType == WeatherType.ANY
