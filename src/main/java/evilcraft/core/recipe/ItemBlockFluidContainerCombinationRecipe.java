...
public class ItemBlockFluidContainerCombinationRecipe implements IRecipe {
     ...
     * Make a new instance.
     * 
     * @param size     The recipe size (should be called multiple times (1 to 9) to allow for all shapeless crafting
     *                 types.
    ...
    public ItemStack getCraftingResult(InventoryCrafting grid) {
        ...
        if (inputItems < 2 || totalCapacity > tankItem.getBlockTank()
            .getMaxCapacity()) {
            return null;
        }
