...
public class EntityHelpers {
    ...
    public static void onEntityCollided(World world, int x, int y, int z, Entity entity) {
        ...
        if (block != null) block.onEntityCollidedWithBlock(world, x, y, z, entity);
    }
        ...
        if (!world.isRemote) {
            while (xp > 0) {
                ...
                world.spawnEntityInWorld(
                    new EntityXPOrb(world, player.posX, player.posY + 0.5D, player.posZ + 0.5D, current));
            }
        }
    }
