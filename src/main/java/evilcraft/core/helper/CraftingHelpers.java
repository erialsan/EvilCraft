...
public class CraftingHelpers {
    ...
    public static IRecipe findCraftingRecipe(ItemStack itemStack, int index)
        throws InfoBookParser.InvalidAppendixException {
        ...
        throw new InfoBookParser.InvalidAppendixException(
            "Could not find crafting recipe for " + itemStack.getItem()
    ...
    public static Map.Entry<ItemStack, ItemStack> findFurnaceRecipe(ItemStack itemStack, int index)
        ...
        throw new InfoBookParser.InvalidAppendixException(
            "Could not find furnace recipe for " + itemStack.getItem()
                .getUnlocalizedName() + "with index " + index);
    }
