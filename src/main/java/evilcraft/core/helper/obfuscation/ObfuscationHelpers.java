...
public class ObfuscationHelpers {
    ...
    public static void setRecentlyHit(EntityLivingBase entity, int recentlyHit) {
        ReflectionHelper
            .setPrivateValue(EntityLivingBase.class, entity, recentlyHit, ObfuscationData.ENTITYLIVINGBASE_RECENTLYHIT);
    }
    ...
    public static String getDeathSound(EntityLivingBase entity) {
        Method method = ReflectionHelper
            .findMethod(EntityLivingBase.class, entity, ObfuscationData.ENTITYLIVINGBASE_GETDEATHSOUND);
        try {
    ...
    public static String getLivingSound(EntityLiving entity) {
        Method method = ReflectionHelper
            .findMethod(EntityLiving.class, entity, ObfuscationData.ENTITYLIVING_GETLIVINGSOUND);
        try {
            return (String) method.invoke(entity);
        } catch (IllegalAccessException e) {
            e.printStackTrace();
    ...
    public static int getItemInUseCount(EntityPlayer player) {
        return ReflectionHelper
            .getPrivateValue(EntityPlayer.class, player, ObfuscationData.ENTITYPLAYER_ITEMINUSECOUNT);
    }
    ...
    public static Method getRenderFaceMethod(RenderBlocks renderer, ForgeDirection direction) {
        Method method = ReflectionHelper.findMethod(
            RenderBlocks.class,
            renderer,
            ObfuscationData.RENDERBLOCKS_RENDERFACE.get(direction),
            Block.class,
            double.class,
            double.class,
            double.class,
    ...
    public static void setPotionEffectDuration(PotionEffect potionEffect, int duration) {
        ReflectionHelper
            .setPrivateValue(PotionEffect.class, potionEffect, duration, ObfuscationData.POTIONEFFECT_DURATION);
    }
     ...
     */
    public static void onChangedPotionEffect(EntityLivingBase entity, PotionEffect potionEffect,
        boolean reapplyAttributes) {
        Method method = ReflectionHelper.findMethod(
            EntityLivingBase.class,
            entity,
            ObfuscationData.ENTITYLIVINGBASE_ONCHANGEDPOTIONEFFECT,
            PotionEffect.class,
            boolean.class);
        try {
