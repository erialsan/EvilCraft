...
public class TerraformDegradation extends StochasticDegradationEffect {
    ...
    public static void initInstance(ExtendedConfig<DegradationEffectConfig> eConfig) {
        if (_instance == null) _instance = new TerraformDegradation(eConfig);
        ...
        if (Configs.isEnabled(NetherfishSpawnConfig.class)) {
            putReplacement(
                ...
                new BlockTypeHolder(
                    ...
                    NetherfishSpawn.getInstance()
                        .getMetadataFromBlock(Blocks.netherrack)),
                50);
        }
    ...
    public void runServerSide(IDegradable degradable) {
        ...
        ILocation blockPoint = LocationHelpers.getRandomPointInSphere(degradable.getLocation(), degradable.getRadius());
        ...
        if (replace != null && !degradable.getLocation()
            .equals(blockPoint) && world.getTileEntity(x, y, z) == null) {
            if (replace.getBlock() == null) {
                world.setBlockToAir(x, y, z);
            } else if (replace.getBlock()
