...
public class EvilCraftTileEntity extends TileEntity {
    ...
    public EvilCraftTileEntity() {
        sendUpdateBackoff = (int) Math.round(Math.random() * getUpdateBackoffTicks()); // Random backoff so not all TE's
    ...
    public void writeToNBT(NBTTagCompound NBTTagCompound) {
        ...
        for (Field field : nbtPersistedFields) writePersistedField(field, NBTTagCompound);
    ...
    public void readFromNBT(NBTTagCompound NBTTagCompound) {
        ...
        for (Field field : nbtPersistedFields) readPersistedField(field, NBTTagCompound);

        // Separate action for direction
        ForgeDirection foundRotation = ForgeDirection.getOrientation(NBTTagCompound.getInteger("rotation"));
