...
public enum ConfigurableTypeCategory {
     ...
     * All the categories.
     */
    public static ConfigurableTypeCategory[] CATEGORIES = new ConfigurableTypeCategory[] { ITEM, BLOCK, FLUID, ENTITY,
        GENERAL, WORLDGENERATION, ENCHANTMENT, MOB, BIOME, DEGRADATIONEFFECT, MACHINE, POTION };
