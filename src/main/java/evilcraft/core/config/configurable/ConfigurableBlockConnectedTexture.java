...
public abstract class ConfigurableBlockConnectedTexture extends ConfigurableBlock {
    ...
    public boolean shouldConnectDirection(IBlockAccess world, ForgeDirection side, int x, int y, int z) {
        return shouldConnect(world, x, y, z)
            && world.getBlock(x + side.offsetX, y + side.offsetY, z + side.offsetZ) == this;
    }
    ...
    public void setRenderPass(int pass) {
        if (pass < getRenderPasses()) this.pass = pass;
        else this.pass = getRenderPasses() - 1;
    }
    ...
    public void registerBlockIcons(IIconRegister iconRegister) {
        ...
        connectableIcon = new ConnectableIcon(
            getIconBackground(),
            getIconBorders(),
            getIconCorners(),
            getIconInnerCorners(),
