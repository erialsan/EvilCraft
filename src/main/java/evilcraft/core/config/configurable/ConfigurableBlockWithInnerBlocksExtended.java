...
public abstract class ConfigurableBlockWithInnerBlocksExtended extends ConfigurableBlockContainer {
    ...
    public ConfigurableBlockWithInnerBlocksExtended(ExtendedConfig eConfig, Material material,
        Class<? extends InnerBlocksTileEntity> tileEntity) {
    ...
    public IIcon getIcon(IBlockAccess world, int x, int y, int z, int side) {
        try {
            return getTile(world, x, y, z).getInnerBlock()
                .getIcon(side, world.getBlockMetadata(x, y, z));
