 ...
 *
 */
public abstract class ConfigurableBlockContainerGuiTankInfo extends ConfigurableBlockContainerGui
    implements IInformationProvider, IBlockTank {

    private BlockTankComponent<ConfigurableBlockContainerGuiTankInfo> tankComponent = new BlockTankComponent<ConfigurableBlockContainerGuiTankInfo>(
        this);
    ...
    public ConfigurableBlockContainerGuiTankInfo(ExtendedConfig eConfig, Material material,
        Class<? extends TankInventoryTileEntity> tileEntity) {
    ...
    public int getComparatorInputOverride(World world, int x, int y, int z, int side) {
        ...
        float output = (float) tile.getTank()
            .getFluidAmount()
            / (float) tile.getTank()
                .getCapacity();
