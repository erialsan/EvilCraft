...
public class ConfigurableType {
     ...
     * Block type.
     */
    public static final ConfigurableType BLOCK = new ConfigurableType(
        true,
        BlockConfig.class,
        new BlockAction(),
     ...
     */
    public static final ConfigurableType BLOCKCONTAINER = new ConfigurableType(
        true,
        BlockConfig.class,
        new BlockAction(),
        ConfigurableTypeCategory.BLOCK);
     ...
     */
    public static final ConfigurableType DEGRADATIONEFFECT = new ConfigurableType(
        true,
        DegradationEffectConfig.class,
        new DegradationEffectAction(),
        ConfigurableTypeCategory.DEGRADATIONEFFECT);
    /**
     * Potion effect type.
     */
