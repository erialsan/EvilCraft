...
public class Location implements ILocation {
    ...
    public boolean equals(Object object) {
        return object instanceof ILocation && ((ILocation) object).getCoordinates()
            .equals(getCoordinates());
    }
    ...
    public ILocation subtract(ILocation location) {
        if (getDimensions() != location.getDimensions()) {
            throw new IllegalArgumentException(
                "The dimensions differ: this: [" + getDimensions() + "] subtractor [" + location.getDimensions() + "]");
        }
    ...
    public ILocation add(ILocation location) {
        if (getDimensions() != location.getDimensions()) {
            throw new IllegalArgumentException(
                "The dimensions differ: this: [" + getDimensions() + "] adder [" + location.getDimensions() + "]");
        }
